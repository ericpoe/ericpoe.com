...
Although my primary programming languages are PHP and JavaScript, I feel confident that I can mentor in [Ruby](https://www.ruby-lang.org/) and Rails due to my experience with [MVC](https://www.futurehosting.com/blog/what-is-an-mvc-framework/) frameworks ([Symfony](https://symfony.com/) and [Laravel](https://laravel.com/)). I worked with Rails at a hackathon in 2013 and I don't think that is sufficient experience; however, Rails has influenced every MVC framework that followed, so this shouldn't be too foreign to me.
