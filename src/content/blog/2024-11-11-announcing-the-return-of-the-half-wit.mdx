...
<Figure
  src={genericBlogPost}
  alt="A bird's-eye view of a wireless Mac keyboard on a rough, weathered wood-plank desk. Superimposed over the image is the word 'Blog' in script. Next to the keyboard is a latte and and a potted barrel cactus that is dangerously too close to the coffee"
