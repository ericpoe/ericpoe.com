...
featuredImage_Alt: 'Cartoon image by @tpope: Parody of Mac vs PC commercials from
  the early 2000s. One man represents Vim and the other represents emacs. A third
  man appears and claims to represent Atom. The first two men are then seen beating
  up the Atom man.'
lastEdited: '2022-01-02T18:30:26Z'
---

import Figure from '../../components/Figure.astro';
import vimEmacsAtomio from './images/vim-emacs-atomio.png';

<Figure
  src={vimEmacsAtomio}
  alt="Cartoon image by @tpope: Parody of Mac vs PC commercials from the early 2000s. One man represents Vim and the other represents emacs. A third man appears and claims to represent Atom. The first two men are then seen beating up the Atom man."
  caption='Image credit: <a href="https://twitter.com/tpope">@tpope</a>'
/>
