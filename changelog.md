...
- Upgraded `gatsby-remark-images` to 3.2.6
- Upgraded `gatsby-remark-prismjs` to 3.4.5
- Upgraded `gatsby-source-filesystem` to 2.2.5
- Upgraded `gatsby-transformer-remark` to 2.7.5
